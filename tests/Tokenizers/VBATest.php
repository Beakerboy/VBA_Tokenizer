...
class VBATest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testTokenizer($string, $expected)
    {
        ...
        $VBA = new NewGenericVBAExtension($string, $config, '\r\n');
        $VBA->callTokenizer();
    ...
    public function dataProviderForTokenizer()
    {
        ...
        $output1 = [
            ...
            [T_FUNCTION, "Function"], [T_STRING, ": Foo"], [T_WHITESPACE, "\r\n"],
            [T_PUBLIC, 'Public'], [T_WHITESPACE, ' '],
            ...
            [T_EQUAL, '='], [T_WHITESPACE, ' '],
            [T_LNUMBER, '3'], [T_WHITESPACE, "\r\n        "],
            [T_CASE_ELSE, 'Case Else'], [T_WHITESPACE, "\r\n            "],
            [T_STRING, 'Foo'], [T_WHITESPACE, ' '],
            [T_EQUAL, '='], [T_WHITESPACE, ' '],
            [T_LNUMBER, '4'], [T_WHITESPACE, "\r\n    "],
            [T_END_SELECT, 'End Select'], [T_WHITESPACE, "\r\n"],
            [T_END_FUNCTION, 'End Function'], [T_WHITESPACE, "\r\n\r\n"],
            ...
            [T_ENDIF, 'End If'], [T_WHITESPACE, "\r\n"],
            [T_END_SUB, 'End Sub'], [T_WHITESPACE, "\r\n\r\n"],
            [T_PUBLIC, 'Public'], [T_WHITESPACE, ' '],
            ...
            [T_CLOSE_PARENTHESIS, ')'],[T_WHITESPACE, "\r\n    "],
            [T_LOOP, 'Loop'], [T_WHITESPACE, "\r\n"],
            [T_END_PROPERTY, 'End Property'], [T_WHITESPACE, "\r\n\r\n"],
            [T_PRIVATE, 'Private'], [T_WHITESPACE, ' '],
            [T_SUB, 'Sub'], [T_WHITESPACE, ' '],
